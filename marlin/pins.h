...
//x axis pins
    ...
    #define X_DIR_PIN       18
    #define X_ENABLE_PIN    19
    #define X_MIN_PIN       11	// PD3 (changed 21 Jan 2015)
    #define X_MAX_PIN       -1
    ...
    #define Z_DIR_PIN       28
    #define Z_ENABLE_PIN    29
    #define Z_MIN_PIN       10  // PD2 (changed 21 Jan 2015)
    #define Z_MAX_PIN       -1
    ...
    #define E0_DIR_PIN       2    //Edited @ EJE Electronics 20100715
    #define E0_ENABLE_PIN    3    //Added @ EJE Electronics 20100715
    #define TEMP_0_PIN      5     //changed @ rkoeppl 20110410		// MUST USE ANALOG INPUT NUMBERING NOT DIGITAL OUTPUT NUMBERING!!!!!!!!!
    #define TEMP_1_PIN      -1    //changed @ rkoeppl 20110410
	...
	// Panelolu2		@ ajienikicio 20140411
	#ifdef LCD_I2C_PANELOLU2
		#define BTN_EN1 30		// ENC_A
		#define BTN_EN2 31		// ENC_B
