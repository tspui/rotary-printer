...
#define ENCODER_FEEDRATE_DEADZONE 10
  ...
  #define ENCODER_STEPS_PER_MENU_ITEM 2		// previously 5 @ ajienikicio 20140525
  #ifndef ENCODER_PULSES_PER_STEP
    #define ENCODER_PULSES_PER_STEP 4		// previously 1 @ ajienikicio 20140525
  #endif
#else
...
void lcd_update()
{
    ...
    if (lcd_next_update_millis < millis())
    {
      wasClicked = LCD_CLICKED;
        ...
        if (lcdDrawUpdate)
            lcdDrawUpdate--;
        lcd_next_update_millis = millis() + 150;	// previously 100 @ ajienikicio 20140525
    }
}
